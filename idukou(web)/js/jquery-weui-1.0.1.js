...
function($) {
	...
	$.modal = function(params, onOpen) {
		...
		var tpl = '<div class="weui-dialog">' +
			'<div class="weui-dialog__hd" style="background:#5DD7AE;color:white;"><strong class="weui-dialog__title">' + params.title + '</strong></div>' +
    ...
    $.tel = function(text, title, onOK, onCancel) {
		var config;
		if(typeof text === 'object') {
			config = text
		} else {
...
function($) {
	...
	var show = function(html, className, maskName) {
		className = className || "";
		var s = "<div class='" + (maskName || "weui-mask_transparent") + "'></div>"
		var mask = $(s).appendTo(document.body);
	...
	$.showLoading = function(text, bg) {
		var html = '<div class="weui_loading">'; 
		html += '<i class="ui-ico-tbd color-green font-16" style="position: absolute;top:24%;left:40%"></i><i class="weui-loading  color-green font-11" style="width:50px;height:50px;background: transparent url(img/4.png) 10px 10px no-repeat;"></i>';
		html += '</div>';
		html += '<p class="weui-toast_content font-13 color-green" style="margin-top: -5px;">' + (text || "数据加载中") + '</p>';
		if(bg) {
			show(html, 'weui_loading_toast ', 'weui-mask weui-mask--visible');
		} else {
...
function($) {
	...
	var showTab = function(a) {
		...
		$($.parseHTML(href)).addClass("weui-tab__bd-item--active");
