...
app.config(function($routeProvider) {
	...
	$routeProvider
		...
		//核销页
		.when('/cancelCoupon', {
			controller: 'cancelCouponC',
			templateUrl: 'partials/cancelCoupon.aspx?' + Math.random()
		})
		//登记页
		.when('/register', {
			controller: 'registerC',
			templateUrl: 'partials/register.aspx?' + Math.random()
		})
		//核销记录
		.when('/couponRecord', {
			controller: 'couponRecordC',
			templateUrl: 'partials/couponRecord.aspx?' + Math.random()
		})	
		//短信登录
		.when('/smsLogin', {
		...
		//登记记录		
		.when('/userRecord/:id', {
			controller: 'userRecordC',
			templateUrl: 'partials/userRecord.aspx?' + Math.random()
		})	
		//我的账户
		.when('/myAccount', {
