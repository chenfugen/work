...
(function($) {
    ...
    function width(a) { if(!a[0]){return 0;} return a[0].offsetWidth + css(a, 'marginLeft') + css(a, 'marginRight') };
    function height(a) { if(!a[0]){return 0;} return a[0].offsetHeight + css(a, 'marginTop') + css(a, 'marginBottom') }
