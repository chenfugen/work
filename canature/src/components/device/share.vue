<template>
	<div class="share">
		<div v-show="shareList.length==0" class="nullShare">
			<img src="../../../static/image/share_default page_bg@2x.png" />
			<p class="title">您还没有分享过</p>
			<van-button round class="gradual_line_blue addShare" @click="sharaDevice">马上分享</van-button>
		</div>
		<ul class="shareList">
			<li class="shareUser" v-for="(item, index) in shareList">
				<img src="../../../static/image/kainenglogo@2x.png" class="shareImg" />
