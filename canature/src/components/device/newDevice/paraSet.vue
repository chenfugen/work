	...
	<div class="paraSet">
		<div class="paraContent">
			<van-cell-group>
				...
				<div v-show="device.productKey=='a1EnF8F09Au'">
					<p class="formInput"></p>
				...
				<van-field v-show="device.productKey=='a1EnF8F09Au'" v-model="para.regenSTimeSet" clear label="再生启动时间" is-link input-align="right" @click="showWashTime" placeholder="请选择时间" readonly/>
				<van-field v-show="device.productKey=='a1EnF8F09Au'" v-model="para.regenSIntervalSet" clear label="再生间隔时间" is-link input-align="right" @click="showOutTime" placeholder="请选择时间" readonly/>
				<van-field v-show="device.productKey!='a1EnF8F09Au'" v-model="para.rinseSTimeSet" clear label="冲洗启动时间" is-link input-align="right" @click="showWashTime" placeholder="请选择时间" readonly/>
				<van-field v-show="device.productKey!='a1EnF8F09Au'" v-model="para.rinseSIntervalSet" clear label="冲洗间隔时间" is-link input-align="right" @click="showOutTime" placeholder="请选择时间" readonly/>
			</van-cell-group>
		</div>
