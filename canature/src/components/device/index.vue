		...
		<v-touch v-on:swipeleft="swiperleft" :swipe-options="{direction: 'horizontal'}" v-on:swiperight="swiperright" class="wrapper">
			<div id="device">
				<div class="header">
					...
					<img src="../../../static/image/icon_sort@2x.png" @click="showFilter" class="device_filter" />
					<img :src="sortImg" @click="showWay" class="device_filter" />
					<div class="filters" v-show="filter">
						<ul class="filterList">
							<li @click="timeSort"><img src="../../../static/image/icon_sort_time@2x.png" /><span class="filter_name">按添加时间排序</span></li>
							<li @click="typeSort"><img src="../../../static/image/icon_sort_product type@2x.png" /><span>按产品类型排序</span></li>
						</ul>
					</div>
				</div>
				<van-pull-refresh v-model="isLoading" @refresh="onRefresh">
					<div v-show="!addDevice" class="nullDevice">
						<img src="../../../static/image/device_default page_bg@2x.png" />
				...
				<img src="../../../static/image/cantureQrcode.jpg" class="codeImg" />
					...
					if(res.data.success) {
						...
						res.data.data.data.forEach(function(msg) {
							if(msg.productFile == null) {
								msg.productImg = "../../../static/image/kainenglogo@2x.png";
							} else {
...
<style lang="scss" scoped>
	...
	.header {
		...
		.filters {
			...
			top: 35px;
			.filterList {
				background: url(../../../static/image/menu@2x.png) no-repeat;
