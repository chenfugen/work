		...
		<el-form :inline="true" :model="searchParams">
			<el-form-item v-for="(item, index) in searchList" :key="index">
				...
				<el-input
					...
					v-model.trim="searchParams[item.prop]"
					:min="item.min"
					:max="item.max"
			...
			<el-form-item>
				...
				></el-button>
				<el-button plain size="mini" @click="resetForm(formName)">
					重置
				</el-button>
			</el-form-item>
			<el-form-item class="rBtn" v-if="isAdd">
				<el-button type="primary" size="mini" @click="add('new')">{{
					buttonName
				}}</el-button>
			</el-form-item>
		</el-form>
