<template>
	<div id="menuAddNew">
		...
		>
			...
			<div class="basic">
				...
				<div class="basic-box">
					...
					<div
						class="basic-right"
						style="width: 393px;height: 495px;
							float: right;
							position: relative;
						"
					>
						...
						<el-upload
							...
							:on-change="
								(file, filesList) =>
									handleChoseFile(file, filesList, 'appImage')
							"
							accept=".jpg"
		...
		<p style="text-align: center">
			...
			<el-button type="danger" @click="handleBeforeSubmit('ruleForm')">下一步</el-button>
		</p>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		handleSubmit: function (form) {
			this.$http.addParentMenu(form).then((res) => {
				this.$hideLoading();
				if (res.data.success) {
					this.$store.commit("chg_riving", false);
					this.$router.push({
						...
						params: {
							...
							appImageName: form.appImageName,
