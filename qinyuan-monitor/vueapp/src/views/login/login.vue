	...
	<div class="login">
		<div class="loginBox">
			...
			<div v-else class="box">
				<p>短信验证</p>
				<el-form :model="smsForm" status-icon :rules="rules" ref="smsForm" class="demo-smsForm" @keyup.enter.native="submitForm('smsForm')" @submit.native.prevent>
