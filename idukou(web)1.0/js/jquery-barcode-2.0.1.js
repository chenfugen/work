...
$.barcode = {
  ...
  digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
    ...
    if (settings.showHRI){
      //content += "<div style=\" width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: " + settings.fontSize + "px; margin-top: " + settings.marginHRI + "px;\">"+hri+"</div>";
    }
